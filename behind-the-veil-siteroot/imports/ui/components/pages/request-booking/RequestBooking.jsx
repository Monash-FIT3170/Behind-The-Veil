                                ...
                                <div className="flex flex-col md:flex-row gap-4 md:gap-10">
                                    ...
                                    <div
                                        ...
                                        <div className="flex flex-col gap-4">
                                            <Input
                                                id={dateInputId}
                                                label={<label htmlFor={dateInputId}
                                                              className="main-text text-our-black">Select
                                                    Date</label>}
                                    ...
                                    <div className="flex flex-col flex-grow gap-1">
                                        ...
                                        <div id={timeInputId} className="grid grid-cols-2 gap-2">
                                            ...
                                            {!Array.isArray(availableTimes) || availableTimes.length === 0 ?
                                                <span
                                                    className={"main-text text-dark-grey text-center col-span-2 mt-4"}>No available times</span> :
