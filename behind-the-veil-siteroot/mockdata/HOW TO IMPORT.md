...
mongoimport -h localhost:3001 --db meteor --collection images --file mockdata/post_images1000.json --jsonArray
mongoimport -h localhost:3001 --db meteor --collection images --file mockdata/post_images1000.json --jsonArray
mongoimport -h localhost:3001 --db meteor --collection images --file mockdata/post_image_selected_user30.json --jsonArray
